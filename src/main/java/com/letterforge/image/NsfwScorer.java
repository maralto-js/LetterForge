...
/**
 * SPI de pontuação NSFW. O core (LetterForge) NÃO embute nenhum motor de ML — ele apenas
 * declara este ponto de extensão. Um addon (ex.: LetterForge-NSFW-Model, premium) carrega
